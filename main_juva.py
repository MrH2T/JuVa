...
import copy
from engine_juva import train_one_epoch, evaluate

from denoiser_juva import Denoiser


def get_args_parser():
    parser = argparse.ArgumentParser('Juva I2V', add_help=False)
    
    # architecture
    parser.add_argument('--model', default='Juva-B/16', type=str, metavar='MODEL',
